...
class AdvancedVibrationCalculator {
    ...
    // teethCount pode ser um objeto { input: n, output: m } ou apenas um número
    const teethInput = (typeof teethCount === 'object' && teethCount.input) ? teethCount.input : (typeof teethCount === 'number' ? teethCount : 0);
    const gearMeshFreq = (inputRpm / 60) * teethInput;
