...
function validarIV() {
    ...
    document.getElementById('result-label').textContent = "Índice de Viscosidade";
...
function validar100() {
	...
	if(500 < result || result < 2) {
        ...
        document.getElementById('result-placeholder').style.display = 'none';
        document.getElementById('result-content').style.display = 'block';
        document.getElementById('result-label').textContent = "Viscosidade a 100°C";
...
function validar40() {
	...
	if(result < kv100 || result < 2 || result > 2000) {
        ...
        document.getElementById('result-placeholder').style.display = 'none';
        document.getElementById('result-content').style.display = 'block';
        document.getElementById('result-label').textContent = "Viscosidade a 40°C";
        document.getElementById('result-value').textContent = result.toFixed(2) + " cSt";
	}
}