...
function validarIV() {
    ...
    document.getElementById('result-label').textContent = i18n.t('grease.visc.result_label_iv');
...
function validar100() {
	...
	if(parseFloat(document.getElementById("visc40c").value) < 2) {
		alert(i18n.t('grease.visc.err_lt2_40_v2'));
		document.getElementById("visc40c").value = "";
		document.getElementById("visc40c").focus();
		return false;
	}
	...
	if(500 < result || result < 2) {
		alert(i18n.t('grease.visc.err_calc'));
	}
	else {
        document.getElementById('result-placeholder').style.display = 'none';
        document.getElementById('result-content').style.display = 'block';
        document.getElementById('result-label').textContent = i18n.t('grease.visc.result_label_100');
        document.getElementById('result-value').textContent = result.toFixed(2) + " cSt";
	}
}
...
function validar40() {
	...
	if(document.getElementById("inVisc").value == "" || isNaN(document.getElementById("inVisc").value)) {
		alert(i18n.t('grease.visc.err_val_vi'));
		document.getElementById("inVisc").value = "";
	...
	if(document.getElementById("visco100c").value == "" || isNaN(document.getElementById("visco100c").value)) {
		alert(i18n.t('grease.visc.err_val_100_v3'));
		document.getElementById("visco100c").value = "";
	...
	if(result < kv100 || result < 2 || result > 2000) {
		alert(i18n.t('grease.visc.err_range'));
	}
	else {
        document.getElementById('result-placeholder').style.display = 'none';
        document.getElementById('result-content').style.display = 'block';
        document.getElementById('result-label').textContent = i18n.t('grease.visc.result_label_40');
        document.getElementById('result-value').textContent = result.toFixed(2) + " cSt";
	}
}