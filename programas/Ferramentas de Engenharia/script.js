...
const engineeringTools = [
    ...
    { id: 'volume-cilindros', name: 'Volume de Cilindros', description: 'Cálculo do volume de cilindros', category: 'calculos', icon: 'fas fa-cylinder', calculator: 'volumeCilindros' },

    // Novas calculadoras implementadas (pendentes)
    { id: 'dimensionamento-eixos', name: 'Dimensionamento de Eixos', description: 'Dimensionamento de eixos por torque (diâmetro)', category: 'calculos', icon: 'fas fa-shaft', calculator: 'dimensionamentoEixos' },
    { id: 'espessura-parede-tubo', name: 'Espessura de Parede do Tubo', description: 'Cálculo da espessura mínima para pressão interna (tubo)', category: 'tabelas', icon: 'fas fa-ring', calculator: 'espessuraParedeTubo' },
    { id: 'pressao-critica-sapata', name: 'Pressão Crítica da Sapata', description: 'Cálculo simples da pressão de contato da sapata (q = P / A)', category: 'calculos', icon: 'fas fa-weight-hanging', calculator: 'pressaoCriticaSapata' },
    { id: 'atrito', name: 'Atrito', description: 'Cálculo de força de atrito a partir de μ e N', category: 'calculos', icon: 'fas fa-hand-rock', calculator: 'atrito' },
    { id: 'calculo-escada', name: 'Cálculo de Escada', description: 'Número de degraus e medidas recomendadas (espelho/piso)', category: 'calculos', icon: 'fas fa-stairs', calculator: 'calculoEscada' },
...
const calculators = {
    ...
    converterAcoConstrucao: function() {
        return `
            <h3>Converter Aço - Construção Civil</h3>
            ...
            <div class="info-section">
                <h4>Tabela de Referência - Aço para Construção Civil</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Bitola (mm)</th>
    ...
    dimensionamentoConstrucao: function() {
        return `
            <h3>Dimensionamento - Construção Civil</h3>
            <div class="calculator-section">
                <div class="input-group">
            ...
            <div class="info-section">
                <h4>Coeficientes de Segurança NBR 6118</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Elemento</th>
    ...
    unidadesVolumeCapacidade: function() {
        return `
            <h3>Conversão de Unidades - Volume e Capacidade</h3>
            <div class="calculator-section">
                <div class="input-group">
            ...
            <div class="info-section">
                <h4>Tabela de Conversão - Volume</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Unidade</th>
    ...
    momentosReacoesApoios: function() {
        return `
            <h3>Cálculo de Momentos e Reações em Apoios</h3>
            <div class="calculator-section">
                <div class="input-group">
    ...
    diametroBarrasCossinetes: function() {
        return `
            <h3>Diâmetro de Barras para Cossinetes</h3>
            <div class="calculator-section">
                <div class="input-group">
            ...
            <div class="info-section">
                <h4>Tabela Completa - Diâmetro de Barras para Cossinetes</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Rosca Externa</th>
    ...
    diametroFuroRosca: function() {
        return `
            <h3>Diâmetro de Furo para Rosca Interna</h3>
            <div class="calculator-section">
                <div class="input-group">
            ...
            <div class="info-section">
                <h4>Tabela Completa - Diâmetro de Furos para Rosca Interna</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Rosca</th>
...
,
    ...
    dimensionamentoEixos: function() {
        return `
            <h3>Dimensionamento de Eixos</h3>
            <div class="input-group">
    ...
    espessuraParedeTubo: function() {
        return `
            <h3>Espessura de Parede do Tubo (Pressão Interna)</h3>
            <div class="input-group">
    ...
    pressaoCriticaSapata: function() {
        return `
            <h3>Pressão Crítica da Sapata</h3>
            <div class="input-group">
    ...
    // Conversão de aço construção civil
    converterAcoConstrucao: function() {
        return `
            <h3>Converter Aço - Construção Civil</h3>
            <div class="calculator-section">
            ...
            <div class="info-section">
                <h4>Bitolas Comerciais de Aço CA</h4>
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>Bitola</th>
...
function renderTools() {
    ...
    toolsGrid.innerHTML = filteredTools.map(tool => {
        ...
        <div class="tool-card" onclick="openTool('${tool.id}')">
            ...
            <div class="tool-badge">${isFunctional ? '<span class="badge functional">Funcional</span>' : '<span class="badge dev">Em desenvolvimento</span>'}</div>
    ...
    if (tool.calculator && calculators[tool.calculator]) {
        ...
        modalContent.innerHTML = `
            <div class="development-notice">
                <h3>⚠️ Ferramenta em Desenvolvimento</h3>
                <p>Esta ferramenta está sendo desenvolvida e estará disponível em breve.</p>
                <p>Para sugestões ou informações adicionais, entre em contato conosco.</p>
            </div>
        `;
    }
...
function converterVolume() {
    ...
    if (isNaN(valor)) {
        document.getElementById("resultado-volume").innerHTML = "Por favor, insira um valor válido.";
        return;
    }
...
function calcularMomentos() {
    ...
    if (isNaN(comprimento)) {
        document.getElementById("resultado-momentos").innerHTML = "Por favor, insira o comprimento da viga.";
        return;
    }
...
function calcularEngrenagens() {
    ...
    if (isNaN(dentes1) || isNaN(dentes2) || isNaN(modulo) || isNaN(rpmMotor)) {
        document.getElementById("resultado-engrenagens").innerHTML = "Por favor, preencha todos os campos.";
        return;
    }
...
function calcularVazao() {
    ...
    if (isNaN(diametroTubo) || isNaN(velocidadeFluido)) {
        document.getElementById("resultado-vazao").innerHTML = "Por favor, preencha todos os campos.";
        return;
    }
...
function calcularVolumeCilindro() {
    ...
    if (isNaN(diametroCilindro) || isNaN(alturaCilindro)) {
        document.getElementById("resultado-volume-cilindro").innerHTML = "Por favor, preencha todos os campos.";
        return;
    }
...
function calcularPorcentagem() {
    ...
    if (isNaN(valor) || isNaN(percentual)) {
        document.getElementById("resultado-porcentagem").innerHTML = "Por favor, preencha todos os campos.";
        return;
    }
...
function calcularDimensionamentoEixos() {
    ...
    if (isNaN(torque) || isNaN(tensao)) {
        document.getElementById('resultado-dimensionamento-eixos').innerHTML = 'Preencha torque e tensão admissível.';
        return;
    }
...
function calcularEspessuraParedeTubo() {
    ...
    if (isNaN(pressaoBar) || isNaN(D_ext_mm) || isNaN(tensaoMPa)) {
        document.getElementById('resultado-espessura-tubo').innerHTML = 'Preencha pressão, diâmetro e tensão.';
        return;
    }
...
function calcularPressaoCriticaSapata() {
    ...
    if (isNaN(carga) || isNaN(largura) || isNaN(comprimento)) {
        document.getElementById('resultado-pressao-sapata').innerHTML = 'Preencha carga e dimensões da sapata.';
        return;
    }
...
function calcularAtrito() {
    ...
    if (isNaN(mu) || isNaN(N)) {
        document.getElementById('resultado-atrito').innerHTML = 'Preencha coeficiente de atrito e força normal.';
        return;
    }
...
function calcularEscada() {
    ...
    if (isNaN(alturaTotal)) {
        document.getElementById('resultado-escada').innerHTML = 'Preencha a altura total da escada.';
        return;
    }
...
window.renderTabelasInox = function() {
    ...
    let html = '<div class="info-section"><h4>Tabela de Chapas (peso por m² aproximado)</h4><table class="data-table"><thead><tr><th>Espessura (mm)</th><th>Peso (kg/m²)</th></tr></thead><tbody>';
    chapas.forEach(c => {
    ...
    html += '<div class="info-section"><h4>Tabela de Tubos (exemplo, peso por metro)</h4><table class="data-table"><thead><tr><th>DN</th><th>Diâmetro Ext (mm)</th><th>Espessura (mm)</th><th>Peso (kg/m)</th></tr></thead><tbody>';
    tubos.forEach(t => {
